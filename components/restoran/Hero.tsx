        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <a 
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-gold px-8 py-4 text-base font-semibold text-navy transition-transform hover:scale-[1.03] hover:shadow-[0_0_24px_rgba(200,164,90,0.4)] active:scale-[0.98] w-full sm:w-auto"
            >
