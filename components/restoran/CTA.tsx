      ...
      <div className="max-w-[800px] mx-auto px-6 text-center relative z-10">
        ...
        >
          <a 
            ...
            className="inline-flex items-center gap-2.5 rounded-xl bg-gold px-8 py-4 text-base font-bold text-navy shadow-lg transition-all duration-300 hover:scale-[1.03] hover:shadow-[0_0_28px_rgba(200,164,90,0.45)] w-full sm:w-auto"
          >
