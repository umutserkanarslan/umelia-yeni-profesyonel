  ...
  return (
    <section id="iletisim" className="noise-bg relative overflow-hidden bg-navy py-28 md:py-32 lg:py-36">
      ...
      <div className="max-w-[800px] mx-auto px-6 text-center relative z-10">
        ...
        >
          Ücretsiz demo ile AI aracımızı test edin. Ekibiniz daha mutlu, misafirleriniz daha memnun.
        </motion.p>
        ...
        >
          <a 
            ...
            className="inline-flex items-center gap-2.5 rounded-xl bg-gold px-8 py-4 text-base font-bold text-navy shadow-lg transition-all duration-300 hover:scale-[1.03] hover:shadow-[0_8px_28px_rgba(200,164,90,0.28)] hover:-translate-y-[2px] w-full sm:w-auto"
          >
          ...
          <a 
            ...
            className="inline-flex items-center gap-2.5 rounded-xl border border-white/30 px-8 py-4 text-base font-semibold text-white transition-all duration-300 hover:border-white hover:bg-white hover:text-navy w-full sm:w-auto text-center justify-center"
          >
            📞 Hemen Arayın
          </a>
        </motion.div>
