        ...
        <div className="flex flex-col md:flex-row items-center gap-12 md:gap-8">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 justify-center md:justify-start">
              <a href="https://wa.me/905316745900" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 rounded-xl bg-gold px-8 py-4 text-base font-semibold text-navy transition-all hover:scale-[1.03] hover:shadow-[0_8px_28px_rgba(200,164,90,0.18)] hover:-translate-y-[2px] active:scale-[0.98]">
